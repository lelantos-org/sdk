...
// public input, `coeffs` the subset the circuit constrains. The 24-word
// difference — the five address words, the clue triples, the aux digest — is
...
const PUBLISHED: readonly {
    ...
    coeffs: number;
    challenge: number;
}[] = [{ shape: TRANSACT_4X6, id: "4x6", coeffs: 46, challenge: 70 }];
