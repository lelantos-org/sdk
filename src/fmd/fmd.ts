...
// bit = 1 iff the Poseidon output is a quadratic residue in 𝔽_r — ~4
// in-circuit constraints/γ (HashToBit gadget) vs ~254 for Num2Bits,
// uniform under Poseidon-as-RO. v2 detection keys derive different bits
// and are NOT interoperable with v3.
//
